...
- [x] **技术栈区块** — **芯片框图呈现**（SoC 外观 + 6 个功能模块 MCU CORE/PERIPHERAL BUS/CONTROL ENGINE/SIMULATION/LANGUAGES/TOOLS & DEBUG + 引脚），筛选器淡化高亮
- [x] **关于区块** — 教育背景 + 6 项荣誉 + **生活侧写（终端档案 + 照片墙占位）** + 联系方式（原 about.html 内容，已删个人简介避免与首页重复）
...
### 中优先级
- [ ] **生活侧写补充素材** — 个人评价 / 个人爱好 / 生活态度 / 3 张生活照（结构已搭好，内容待填）
- [ ] 全向轮步兵项目添加演示视频（如有）
- [ ] 视频封面首帧截取在移动端的效果验证
- [ ] SEO meta 标签优化
