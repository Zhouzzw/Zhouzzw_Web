...
- [x] **项目经历区块** — 串联腿平衡步兵 + 全向轮步兵 + 3 个演示视频（已删 IDE 代码窗口；照片在视频前）
- [x] **技术栈区块** — **芯片框图呈现**（SoC 外观 + 6 个功能模块 MCU CORE/PERIPHERAL BUS/CONTROL ENGINE/SIMULATION/LANGUAGES/TOOLS & DEBUG + 引脚，模块拉长更舒展），筛选器淡化高亮
- [x] **关于区块** — 6 项荣誉 + **生活侧写（终端档案 life.txt：评价/爱好/态度 + 4 张生活照墙）** + 联系方式（已删教育背景与个人简介，避免与首页重复）
...
- [ ] 视频封面首帧截取在移动端的效果验证
- [ ] SEO meta 标签优化
- [ ] 生活侧写补充照片（若有更多素材；已有 4 张：徒步×2/攀岩/骑行）
