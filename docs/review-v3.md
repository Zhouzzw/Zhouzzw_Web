...
🚫 通栏黑带分隔条 · 全站统一暗色背景 · 竖版视频 16:9 裁切修复 · char-matrix 接入技术栈 · **B6 锚点落点描边**（2026-09-15 实现后否决）· **B7 Hero SCROLL 刻度**（同日实现后否决）· **A3「9 图标统一白底衬」**（2026-09-16 实现后否决）

## 三、已确认结论（勿重做 / 勿误判）

**已完成清单（细节见 PROGRESS 快照与 git 历史）**：A1 · A2 · A5（复核不成立）· **A4 / A6**（2026-09-16 布局重排）· A10 · **A11 / A12 / A15**（同日断点族）· A13 · A14 · A16 · **B1–B5 全部** · I1–I3 · I5–I10 · J1–J8 · K1 / K4 / K5 全部落地。
...
- **页高基线（CDP 实测）**：1440×900＝**14257**（A4/A6 布局重排后；原 15640）· 390×844＝**14332** · 360×844＝**14555**（移动端不受 A4/A6 影响）。⚠️ hero 用 `svh`，**跨 `--h` 比较无意义**；只信同 run 内 base↔cur 差值
