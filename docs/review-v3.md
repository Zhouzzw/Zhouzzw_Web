...
🚫 通栏黑带分隔条 · 全站统一暗色背景 · 竖版视频 16:9 裁切修复 · char-matrix 接入技术栈 · **B6 锚点落点描边**（2026-09-15 实现后否决）· **B7 Hero SCROLL 刻度**（同日实现后否决）· **A3「9 图标统一白底衬」**（2026-09-16 实现后否决）· **A4 简介区 12 栅格「文字 6 列 + 照片 5 列右偏」**（同日实现后经用户看效果否决并退回原版，勿再提该方向）

## 三、已确认结论（勿重做 / 勿误判）

**已完成清单（细节见 PROGRESS 快照与 git 历史）**：A1 · A2 · A5（复核不成立）· **A6**（2026-09-16 项目卡并排 + 成果字号同级；A4 同日实现后被否决退回）· A10 · **A11 / A12 / A15**（同日断点族）· A13 · A14 · A16 · **B1–B5 全部** · I1–I3 · I5–I10 · J1–J8 · K1 / K4 / K5 全部落地。
...
- **页高基线（CDP 实测）**：1440×900＝**15120** · 390×844＝**14407** · 360×844＝**14633**（A4 退回 + A6 并排 + 成果字号放大后；移动端 +75/+78px 来自成果字号变大）。⚠️ hero 用 `svh`，**跨 `--h` 比较无意义**；只信同 run 内 base↔cur 差值
